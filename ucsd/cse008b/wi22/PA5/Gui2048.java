...
public class Gui2048 extends Application
{
    ...
    private Text displayText(Rectangle rect, String text) {
        ...
        // Feel free to change
        titleText.setFont(Font.font("Times New Roman", FontWeight.BOLD, FontPosture.ITALIC, 50));
       ...
       for (int row = 0; row < this.boardSize; row++) {
          for (int column = 0; column < this.boardSize; column++) {
             ...
             if ( tileValue == 0 ) {
                ...
                textList.get(counter).setFont(Font.font("Times New Roman", FontWeight.BOLD,30));
             }
