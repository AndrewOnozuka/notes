...
void Scene::draw(void){
     ...
     */
    matrix_stack.push(cur_VM); // Push initial transformation
    ...
    while( ! dfs_stack.empty() ){
         ...
         * TODO: (HW3 hint: you should do something here)
         */
        cur_VM = matrix_stack.top(); matrix_stack.pop(); // Restore the parent transformation
        ...
        for ( size_t i = 0; i < cur -> childnodes.size(); i++ ){
             ...
             * TODO: (HW3 hint: you should do something here)
             */
            mat4 child_VM = cur_VM * cur->childtransforms[i]; 
            matrix_stack.push(child_VM);
        }
