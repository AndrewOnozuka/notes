...
class Maze {
	...
	public ArrayList<Square> storePath() {
		ArrayList<Square> storePath = new ArrayList<>();
		Square finishCopy = this.finish;
		while (finishCopy != null) {
			storePath.add(0, finishCopy);
			finishCopy = finishCopy.getPrevious();
		}
//		storePath.add(this.start);
		return storePath;
	}
}
